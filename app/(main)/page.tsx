	...
	return (
		<>
			<section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 grainy">
				<div className="container p-8 mx-auto flex max-w-5xl flex-col items-center gap-4 text-center relative isolate">
					<div
						aria-hidden="true"
			...
			{/* Categories Section */}
			<section id="categories" className="container p-8 mx-auto space-y-6  py-8  md:py-12 lg:py-24">
						...
						return (
							...
							>
								<div className="flex  flex-col gap-4 items-center justify-between rounded-md p-6">
									<Image src={category.thumbnail} alt={category.title} width={100} height={100} />
			...
			{/* Courses */}
			<section id="courses" className="container p-8 mx-auto space-y-6   md:py-12 lg:py-24">
				<div className="flex items-center justify-between">
							...
							<Link key={category.id} href={`/courses/${category.id}`}>
								<div className="group hover:shadow-sm transition overflow-hidden border rounded-lg p-3 h-full">
									...
									<div className="flex flex-col pt-2">
										...
										<CourseProgress size="sm" value={80} variant={100 === 100 ? "success" : "default"} />
